		...
		<div class="row">
			...
			<div class="col-md-3 text-center">
				<div class="block-search pull-right">
					<h3>{{ lang.page_find_responsible }}</h3>
					<ul class="list-unstyled">
						<li><a href="#" class="get_ajax_form" data-type="siteSearch" data-sub="modal_search" data-void="1">{{ lang.search_translate  }}</a></li>
						<li><a href="#" class="get_ajax_form" data-type="siteSearch" data-sub="modal_search" data-void="2">{{ lang.search_lang  }}</a></li>
						<li><a href="#" class="get_ajax_form" data-type="siteSearch" data-sub="modal_search" data-void="3">{{ lang.search_gid  }}</a></li>
					</ul>
				</div>
				<div class="block-feed pull-right">
					<p>{{ lang.page_feedback_btn }}</p>
					<button class="btn btn-default" data-toggle="modal" data-target="#support">{{ lang.page_feedback_write_btn }}</button>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="media servis">
								...
								<div class="media-body">
									<h4 class="media-heading">{{ lang.page_middle_var_for_owner_5 }}</h4>
									<p>{{ lang.page_middle_var_for_owner_51 }}</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="media paperplane">
								...
								<div class="hidden-elem"><p>{{ lang.page_middle_var_for_owner_11_desc }}</p></div>
								<div class="media-body">
									<h4 class="media-heading">{{ lang.page_middle_var_for_responsible_1 }}</h4>
									<p>{{ lang.page_middle_var_for_responsible_11 }}</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="media krug">
								...
								<div class="hidden-elem"><p>{{ lang.page_middle_var_for_owner_44_desc }}</p></div>
								<div class="media-body">
									<h4 class="media-heading">{{ lang.page_middle_var_for_responsible_4 }}</h4>
									<p>{{ lang.page_middle_var_for_responsible_41 }}</p>
								</div>
							</div>
						</div>
						<div class="clearfix"></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="media krug">
								...
								<div class="hidden-elem"><p>{{ lang.page_middle_var_for_owner_66_desc }}</p></div>
								<div class="media-body">
									<h4 class="media-heading">{{ lang.page_middle_var_for_responsible_6 }}</h4>
									<p>{{ lang.page_middle_var_for_responsible_61 }}</p>
								</div>
							</div>
						</div>
						{% if not SESSION.user_id %}
	...
	<div class="container">
		<div class="row mg-0">
			<div class="col-md-3 pd-0 pl-15 col-sm-3 col-xs-12">
				<div class="service service-item-1">
					<img src="{{ ABS_PATH }}assets/site/template/images/services_bg.jpg" alt="">
					<p>{{ lang.page_service_list }}</p>
				</div>
			</div>
			<div class="col-md-3 pd-0 col-sm-3 col-xs-12">
				<div class="service service-item-2">
					<img src="{{ ABS_PATH }}assets/site/template/images/translator.jpg" alt="">
					<a href="">{{ lang.page_service_list1 }}</a>
					<div class="hidden-service-block">
						<ul class="list-unstyled">
							{% for service_id, service_value in service_filter.1 %}
								<li><a href="{{ HOST_NAME }}{{ link_lang_pref }}/perevodchik/?serv_type_service[]={{ service_value.id|escape|stripslashes }}">{{ service_value.title|escape|stripslashes }}</a></li>
							{% endfor %}
						</ul>
					</div>
				</div>
			...
			<div class="col-md-3 pd-0 col-sm-3 col-xs-12">
				<div class="service service-item-3">
					<img src="{{ ABS_PATH }}assets/site/template/images/language.jpg" alt="">
					<a href="">{{ lang.page_service_list2 }}</a>
					<div class="hidden-service-block">
						<ul class="list-unstyled">
							{% for service_id, service_value in service_filter.2 %}
								<li><a href="{{ HOST_NAME }}{{ link_lang_pref }}/prepodavatel/?serv_type_service[]={{ service_value.id|escape|stripslashes }}">{{ service_value.title|escape|stripslashes }}</a></li>
							{% endfor %}
						</ul>
					</div>
				</div>
			</div>
			<div class="col-md-3 pd-0 pr-15 col-sm-3 col-xs-12">
				<div class="service service-item-4">
					<img src="{{ ABS_PATH }}assets/site/template/images/guide.jpg" alt="">
					<a href="">{{ lang.page_service_list3 }}</a>
					<div class="hidden-service-block">
						<ul class="list-unstyled">
							{% for service_id, service_value in service_filter.3 %}
								<li><a href="{{ HOST_NAME }}{{ link_lang_pref }}/gid/?serv_type_service[]={{ service_value.id|escape|stripslashes }}">{{ service_value.title|escape|stripslashes }}</a></li>
							{% endfor %}
						</ul>
					</div>
				</div>
		...
		<div class="sky-carousel">
			<div class="sky-carousel-wrapper">
				<ul class="sky-carousel-container">
					...
					<li>
						<img src="{{ ABS_PATH }}?thumb={{ app.app_upload_dir }}/users/{{ user.user_photo }}&width=165&height=190" alt="" />
						<div class="worker-name">
							<p>{{ user.user_name|escape|stripslashes }}</p>
						</div>
						<div class="worker-info">
							<p>{{ user.user_name|escape|stripslashes }}</p>
							<p>{% for skill in user.user_skill %}
								{{ lang.lk_skill_one_lang_array[user.user_group][skill]|escape|stripslashes }}<br>
							{% endfor %}</p>
							<a href="{{ HOST_NAME }}/profile-{{ user.id }}/" class="btn btn-block btn-readmore">{{ lang.page_more_btn }}</a>
						</div>
					</li>
					{% endfor %}
				</ul>
		...
		<div class="row">
			<div class="col-md-5 col-sm-5 col-xs-12">
				<div class="row news-items">
					{% for news in news_list|slice(0, 2) %}
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="item-news">
								<div class="caption">
									<h3>
										<a href="{{ HOST_NAME }}/{{ news.page_alias|escape|stripslashes }}">{{ news.page_title|escape|stripslashes|truncate('80') }}</a>
									</h3>
								</div>
			...
			<div class="col-md-5 col-sm-5 col-xs-12">
				<div class="row news-items">
					{% for news in news_list|slice(2, 2) %}
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="item-news">
								<div class="caption">
									<h3>
										<a href="{{ HOST_NAME }}/{{ news.page_alias|escape|stripslashes }}">{{ news.page_title|escape|stripslashes }}</a>
									</h3>
								</div>
								<p class="date-news">{{ news.page_add }}</p>
								<a href="{{ HOST_NAME }}/{{ news.page_alias|escape|stripslashes }}">
...
<script>
	$(function() {
		...
		$(".change_reg").on('click',function() {
			var this_type = $(this).attr("data-type");
			if(this_type == 1) {
				$(".change_group_register li").first().find("a").trigger('click');
			} else {
				$(".change_group_register li").last().find("a").trigger('click');
			}
		});
	});
</script>
