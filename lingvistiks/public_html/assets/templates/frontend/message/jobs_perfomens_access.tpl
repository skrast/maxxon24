		...
		<div class="messages-footer">
			...
			{% else %}
				...
				<div class="row buttons-block">
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}{{ link_lang_pref }}/resume-{{ respons_info.response_perfomens }}/" class="btn btn-block">{{ lang.resume_page }}</a>
					</div>
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}/message/?message_to={{ respons_info.response_perfomens }}" class="btn btn-block">{{ lang.lk_profile_message }}</a>
					</div>
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}/jobs/accept-{{ respons_info.response_id }}/?ref=mess" class="btn btn-block">{{ lang.order_accept }}</a>
					</div>
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}/jobs/deny-{{ respons_info.response_id }}/?ref=mess" class="btn btn-block">{{ lang.order_deny }}</a>
					</div>
				</div>
