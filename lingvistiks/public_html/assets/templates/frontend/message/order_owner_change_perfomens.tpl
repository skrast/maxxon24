<div class="messages-block {% if not respons_info.response_owner_accept and not respons_info.response_owner_not_accept %}suggestions{% endif %}">
	<div class="messages-header">
		<h4>{{ lang.message_order_owner_change_perfomens }}</h4>
	</div>
	<div class="messages-content">
		...
		<div class="messages-footer">
			{% if respons_info.response_perfomens_accept %}
				...
				<a href="{{ HOST_NAME }}/message/?message_to={{ order_info.order_owner }}" class="feedback-with-us">{{ lang.lk_profile_message }}</a>
			{% elseif respons_info.response_perfomens_not_accept %}
				<p>{{ lang.bot_order_perfomens_not_appruve }}</p>
			{% else %}

				<div class="row buttons-block">
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}{{ link_lang_pref }}/profile-{{ order_info.order_owner }}/" class="btn btn-block">{{ lang.lk_profile }}</a>
					</div>
					<div class="col-md-6">
						<a href="{{ HOST_NAME }}/message/?message_to={{ order_info.order_owner }}" class="btn btn-block">{{ lang.lk_profile_message }}</a>
					</div>
					<div class="col-md-6">
