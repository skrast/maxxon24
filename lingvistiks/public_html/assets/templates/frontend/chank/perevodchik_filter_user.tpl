<div class="row">
            ...
            <div class="col-md-7">
                <div class="type-translate {% if REQUEST.user_type == 1 %}{% else %}hidden{% endif %}">
                    <select class="form-control selectpicker" name="serv_theme">
                        <option data-hidden="true" value="" disable>{{ lang.lk_info_theme }}</option>
    ...
    <div class="col-md-5">
        <div class="row">
            ...
            <div class="col-md-12 left-pad-0">
                <div class="form-group">
                    <select class="form-control selectpicker" name="lang_from_temp" data-live-search="true">
                        <option data-hidden="true" value="" disable>{{ lang.lk_lang_1 }}</option>
                ...
                <div class="form-group">
                    <select class="form-control selectpicker" name="lang_to_temp" data-live-search="true">
                        <option data-hidden="true" value="" disable>{{ lang.lk_lang_2 }}</option>
                        {% for lang in lang_list %}
            ...
            {% if 3 != REQUEST.user_type %}
                <div class="row cash">
                    <div class="col-md-12 budget">
                        ...
                        <div class="col-md-offset-3 col-md-4 left-pad-0">
                            <div class="form-group">
